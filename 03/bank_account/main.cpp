...
int main()
{
    /*Account test1 = Account("Viktor", true);
    Account test2 = Account("Gena", false);
    Account test3 = Account("Valera", false);

    test1.save_money(200);
    test2.save_money(100);
    test3.save_money(50);

    print_three_accounts(test1, test2, test3);
    test1.transfer_to(test3,200);
    print_three_accounts(test1, test2, test3);*/
